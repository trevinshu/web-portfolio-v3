...
function Header() {
  return (
    <header className="flex flex-col justify-center items-center gap-3">
      ...
      <p className="text-zinc-600 text-xl text-center uppercase tracking-widest underline decoration-wavy decoration-indigo-800 underline-offset-8">Web Developer</p>
    </header>
  );
}
